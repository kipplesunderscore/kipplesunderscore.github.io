...
**** Keep 3
Seeing as how we have the need_sa function the first thing we should try is just blindly pushing all but 3 elements into stack B. then if we need to perform a *sa*
